...
import "../../accumulators/GeometricPriceAccumulator.sol";

contract GeometricPriceAccumulatorStub is GeometricPriceAccumulator {
    struct Config {
    ...
    ) GeometricPriceAccumulator(quoteToken_, updateThreshold_, minUpdateDelay_, maxUpdateDelay_) {}
...
contract GeometricPriceAccumulatorStubCaller {
    GeometricPriceAccumulatorStub immutable callee;

    constructor(GeometricPriceAccumulatorStub callee_) {
        callee = callee_;
    }
