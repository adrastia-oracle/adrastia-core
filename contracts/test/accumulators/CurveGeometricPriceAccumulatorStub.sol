...
import "../../accumulators/proto/curve/CurveGeometricPriceAccumulator.sol";

contract CurveGeometricPriceAccumulatorStub is CurveGeometricPriceAccumulator {
    constructor(
        address pool_,
        int8 nCoins_,
        ...
        CurveGeometricPriceAccumulator(
            pool_,
            nCoins_,
            poolQuoteToken_,
            ourQuoteToken_,
