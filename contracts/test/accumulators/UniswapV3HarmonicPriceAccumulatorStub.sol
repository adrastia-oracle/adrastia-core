...
import "../../accumulators/proto/uniswap/UniswapV3HarmonicPriceAccumulator.sol";

contract UniswapV3HarmonicPriceAccumulatorStub is UniswapV3HarmonicPriceAccumulator {
    constructor(
        ...
        UniswapV3HarmonicPriceAccumulator(
            uniswapFactory_,
            initCodeHash_,
            poolFees_,
            quoteToken_,
