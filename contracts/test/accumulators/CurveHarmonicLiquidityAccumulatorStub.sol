...
import "../../accumulators/proto/curve/CurveHarmonicLiquidityAccumulator.sol";

contract CurveHarmonicLiquidityAccumulatorStub is CurveHarmonicLiquidityAccumulator {
    constructor(
        address pool_,
        uint8 nCoins_,
        ...
        CurveHarmonicLiquidityAccumulator(
            pool_,
            nCoins_,
            poolQuoteToken_,
            ourQuoteToken_,
