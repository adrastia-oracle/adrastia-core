...
import "../../accumulators/GeometricLiquidityAccumulator.sol";

contract GeometricLiquidityAccumulatorStub is GeometricLiquidityAccumulator {
    ...
    ) GeometricLiquidityAccumulator(quoteToken_, updateThreshold_, minUpdateDelay_, maxUpdateDelay_) {}
...
contract GeometricLiquidityAccumulatorStubCaller {
    GeometricLiquidityAccumulatorStub immutable callee;

    constructor(GeometricLiquidityAccumulatorStub callee_) {
        callee = callee_;
    }
