...
import "../../accumulators/HarmonicPriceAccumulator.sol";

contract HarmonicPriceAccumulatorStub is HarmonicPriceAccumulator {
    struct Config {
    ...
    ) HarmonicPriceAccumulator(quoteToken_, updateThreshold_, minUpdateDelay_, maxUpdateDelay_) {}
...
contract HarmonicPriceAccumulatorStubCaller {
    HarmonicPriceAccumulatorStub immutable callee;

    constructor(HarmonicPriceAccumulatorStub callee_) {
        callee = callee_;
    }
