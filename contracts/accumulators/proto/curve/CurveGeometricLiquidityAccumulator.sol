...
contract CurveGeometricLiquidityAccumulator is GeometricLiquidityAccumulator {
    ...
    ) GeometricLiquidityAccumulator(ourQuoteToken_, updateTheshold_, minUpdateDelay_, maxUpdateDelay_) {
