...
contract CurveHarmonicLiquidityAccumulator is HarmonicLiquidityAccumulator {
    ...
    ) HarmonicLiquidityAccumulator(ourQuoteToken_, updateTheshold_, minUpdateDelay_, maxUpdateDelay_) {
