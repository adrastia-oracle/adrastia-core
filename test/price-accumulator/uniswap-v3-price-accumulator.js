...
function describeUniswapV3PriceAccumulatorTests(contractName, stubContractName) {
    ...
    describe(contractName + "#computeAddress", function () {
        var accumulator;
...
describeUniswapV3PriceAccumulatorTests("UniswapV3PriceAccumulator", "UniswapV3PriceAccumulatorStub");
describeUniswapV3PriceAccumulatorTests("UniswapV3HarmonicPriceAccumulator", "UniswapV3HarmonicPriceAccumulatorStub");
describeUniswapV3PriceAccumulatorTests("UniswapV3GeometricPriceAccumulator", "UniswapV3GeometricPriceAccumulatorStub");
